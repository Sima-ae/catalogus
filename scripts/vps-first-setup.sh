...
echo "  2. GitHub secrets: VPS_HOST, VPS_USER=root, VPS_SSH_KEY (deploy key, no passphrase)"
echo "     bash $APP_DIR/scripts/setup-github-deploy-ssh.sh  OR copy secrets from inkoop.autos"
echo "  3. VPS_APP_PATH=$APP_DIR"
echo "  4. Run: bash $APP_DIR/scripts/deploy.sh"
echo "  5. LiteSpeed: $APP_DIR/deploy/htaccess.example"
