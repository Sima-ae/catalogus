...
echo "  2. GitHub secrets: VPS_HOST, VPS_USER=root, VPS_SSH_KEY=<your existing root private key>"
echo "     (must match /root/.ssh/authorized_keys — do not change server keys)"
