...
export function serializeProductRow(
  ...
  return {
    ...
    sold_out: row.sold_out === 1 || row.sold_out === true || row.sold_out === '1',
    pre_order: row.pre_order === 1 || row.pre_order === true || row.pre_order === '1',
    public_share:
      row.public_share === 1 || row.public_share === true || row.public_share === '1',
