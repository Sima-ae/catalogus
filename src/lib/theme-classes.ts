...
export function useAppTheme() {
  ...
  return {
    ...
    sectionTitle: isDark ? 'text-gray-50' : 'text-gray-900',
    body: isDark ? 'text-gray-200' : 'text-gray-800',
    label: isDark ? 'text-gray-200' : 'text-gray-900',
    muted: isDark ? 'text-gray-400' : 'text-gray-700',
    hint: isDark ? 'text-gray-400' : 'text-gray-600',
    link: isDark ? 'text-primary-400 hover:underline' : 'text-gray-900 font-medium underline hover:text-black',
