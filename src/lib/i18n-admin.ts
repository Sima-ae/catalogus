...
const EN: AdminMessages = {
  ...
  'admin.logout': "Logout",
  'admin.searchPlaceholder': "Search your route...",
...
const BY_LOCALE: Partial<Record<Locale, Partial<AdminMessages>>> = {
  ...
  'admin.searchPlaceholder': "Zoek in je route...",
  ...
  'admin.searchPlaceholder': "Route durchsuchen...",
  ...
  'admin.searchPlaceholder': "Rechercher votre route...",
  ...
  'admin.searchPlaceholder': "Buscar en tu ruta...",
  ...
  'admin.searchPlaceholder': "Pesquisar na rota...",
  ...
  'admin.logout': "Esci",
  'admin.searchPlaceholder': "Cerca nella route...",
...
export function getAdminMessages(locale: Locale): AdminMessages {
  return { ...EN, ...(BY_LOCALE[locale] ?? {}) } as AdminMessages
}
