...
const MESSAGES: Partial<Record<Locale, Messages>> = {
  en: {
    ...
    'pricelist.filter.showWithPrices': 'With prices ({count})',
  ...
  nl: {
    ...
    'pricelist.filter.showMissingPrices': 'Toon alle ontbrekende prijzen ({count})',
    'pricelist.filter.showWithPrices': 'Met prijzen ({count})',
