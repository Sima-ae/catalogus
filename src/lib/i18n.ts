...
const MESSAGES: Partial<Record<Locale, Messages>> = {
  en: {
    ...
    'chat.v1Hint': 'Tip: Click “Ask a price” on a product to request a quote in live chat.',
  ...
  nl: {
    ...
    'chat.v1Hint': 'Tip: Klik op “Prijs aanvragen” bij een product om via de chat een offerte aan te vragen.',
