...
import { getProductFeaturedMessages } from '@/lib/i18n-product-featured'
...
const MESSAGES: Partial<Record<Locale, Messages>> = {
  en: {
    ...
    'productCard.editBrand': 'Edit brand',
    'productCard.quickEdit': 'Edit title & brand',
    'productCard.nameRequired': 'Title is required',
    ...
    'product.priceOnRequest': 'Ask a price',
  ...
  nl: {
    ...
    'productCard.editBrand': 'Merk bewerken',
    'productCard.quickEdit': 'Titel en merk bewerken',
    'productCard.nameRequired': 'Titel is verplicht',
    ...
    'product.priceOnRequest': 'Prijs aanvragen',
    ...
    'product.addingToCart': 'Bestellen…',
    'product.addToCart': 'Bestellen',
    'product.reviews': 'Reviews',
    'product.reviewsCount': '({count} reviews)',
    'product.downloads': '{count} downloads',
...
export function getMessages(locale: Locale): Messages {
  ...
  return {
    ...
    ...getProductFeaturedMessages(locale),
